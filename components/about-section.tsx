                ...
                <div className="py-8 md:py-10 px-6 md:px-8">
                    ...
                    <div className="space-y-2 text-muted-foreground/60">
                        <p className="flex items-start gap-2">
                            ...
                            <span>
                                <strong className="text-muted-foreground/80">Creative problem-solver</strong> who approaches challenges from unique angles and builds
                        ...
                        <p className="flex items-start gap-2">
                            <span className="inline-block size-1.5 rounded-full bg-primary mt-2 shrink-0" />
                            <span>
                                <strong className="text-muted-foreground/80">Rapid learner</strong> with hands-on experience in modern web technologies through personal
                        ...
                        <p className="flex items-start gap-2">
                            <span className="inline-block size-1.5 rounded-full bg-primary mt-2 shrink-0" />
                            <span>
                                <strong className="text-muted-foreground/80">Actively seeking</strong> to launch my career and contribute to a dynamic engineering team that
